...
export const PropertyDetailView = () => {
  ...
  return (
    <div className="mx-auto p-4 sm:p-6 lg:p-8 bg-slate-50 min-h-screen">
      ...
      {/* Pestañas para vista de detalles e historial de visitas */}
      ...
      {activeTab === "info" ? (
        <>
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-8">
            ...
            <div className="px-6 py-6 sm:px-8 border-b border-slate-200 bg-slate-50">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                ...
                {/* Contenedor para agrupar las insignias */}
                <div className="flex flex-wrap items-center gap-2">
                  {/* Insignia de Exclusiva */}
                  {currentProperty.exclusiva && (
                    <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wide bg-amber-50 text-amber-700 border border-amber-200 shadow-sm">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="currentColor"
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8 w-full">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sm:p-8 h-full w-full">
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-6 border-b border-slate-200 pb-4">
                Descripción General
              </h3>
