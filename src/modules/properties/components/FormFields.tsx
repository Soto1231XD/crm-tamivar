...
export function FieldInput({ label, name, value, onChange, type = 'text', inputMode, required, min, step, className }: FieldInputProps) {
  return (
...
export function FieldSelect({ label, name, value, onChange, options, required, className }: FieldSelectProps) {
  return (
    <label className={`flex flex-col gap-1 text-sm text-slate-700 ${className ?? ''}`}>
      <LabelText label={label} required={required} />
...
export function FieldTextarea({ label, name, value, onChange, className }: FieldTextareaProps) {
  return (
    <label className={`flex flex-col gap-1 text-sm text-slate-700 ${className ?? ''}`}>
...
export function Toggle({ name, label, checked, onChange, className }: ToggleProps) {
  return (
...
export function PaymentMultiSelect({ label, selectedValues, options, onToggle, className, required }: PaymentMultiSelectProps) {
  return (
